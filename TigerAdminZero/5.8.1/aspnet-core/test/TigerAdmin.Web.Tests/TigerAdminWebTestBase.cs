...
{
    public abstract class TigerAdminWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TigerAdminWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TigerAdminWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TigerAdminDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TigerAdminDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TigerAdminDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TigerAdminDbContext, Task<T>> func)
        {
            T result;
